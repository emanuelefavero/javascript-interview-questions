...
// new Date(milliseconds) - if you only pass one parameter, it will be treated as milliseconds
...
// new Date(date string) - if you pass a date string, it will be treated as a date (month here is 1-12, not 0-11)
